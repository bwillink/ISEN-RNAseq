#read tables
S1_F_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S1_F/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S3_F_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S3_F/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S3_M_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S3_M/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S4_F_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S4_F/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S4_M_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S4_M/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S6_7_F_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S6_7_F/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
S6_7_M_MXE_file<-read.delim("/Users/ahrim/Desktop/LAB/Output/rMATs/S6_7_M/MXE.MATS.JC.txt", sep = "\t", dec = ".", header = TRUE)
